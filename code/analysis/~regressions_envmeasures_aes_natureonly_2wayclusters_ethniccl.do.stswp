...
esttab zaes1 zaes2 zaes3 zaes5 zaes6 zaes7 zaes8 zaes9 zaes11 zaes12 ///
	using "${tables}/Table_folklore_zaes_natureonly_2wcluster_v114.tex", ///
	...
	prehead(`"\begin{tabular}[t]{l*{10}{c}}"' ///
			`"\toprule"' ///
			`" & \multicolumn{10}{c}{Environmental Measures (ZAES) - Nature Exclusive (2-way clustered SEs)} \\"' ///
			`"\cmidrule(lr){2-11}"' ///
	...
	postfoot(`" & & & & & & & & & & \\"' ///
			 ...
			 `"Cultural clusters & ${clf1} & ${clf2} & ${clf3} & ${clf5} & ${clf6} & ${clf7} & ${clf8} & ${clf9} & ${clf11} & ${clf12} \\"' ///
