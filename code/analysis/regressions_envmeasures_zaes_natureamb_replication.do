...
*-------------------------------------------------------------------------------
* Replacing vars for dual version 
drop sh_nat_socl_atl sh_nat_scl_atl sh_nat_ocl_atl 

*Nature exclusive variables 
gen sh_nat_socl_atl=sh_nature_any_motif_atl
gen sh_nat_scl_atl=sh_nature_smotif_atleast_excl
gen sh_nat_ocl_atl=sh_nature_omotif_atleast_excl
...
esttab a1 a2 a3 a4 a5 ///
	using "${tables}/Table_folklore_zaes_natureamb_final.tex", ///
